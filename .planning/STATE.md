...
Last activity: 2026-07-18 — Completed quick task 260717-sjg: added a subtle animated galaxy nebula backdrop (CSS gradient layer) behind the GizzVerse constellation, with the canvas made transparent so it shows through and drift gated on prefers-reduced-motion
