...
---
*Last updated: 2026-07-19 — milestone v1.2 "Pre-Show Hardening" underway: Phase 11 (Live-Sync & Prediction Correctness) COMPLETE — LIVE-01/02/03 + PRED-01/02/03, 5/5 plans, code-review blocker CR-01 fixed, 620 tests green, on-device UAT signed off. Next: Phase 12 (Data Safety & Integrity). v1.0 MVP and v1.1 shipped and archived; app is show-ready. First show Aug 14, 2026.*
