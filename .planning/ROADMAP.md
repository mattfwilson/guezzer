...
- [x] 04-06-PLAN.md — Set structure + comet trail + tally + undo/edit (SHOW-06/07/08/09)
...
- [x] 05-02-PLAN.md — Data-safety core: versioned export envelope + serializeExport + parseAndMergeImport union-merge/dedupe (PWA-04)
- [x] 05-04-PLAN.md — Live-sync UI slice: useLatestPoll/useOnlineStatus + SuggestionStrip + SyncDot + adopt/bind wiring (SYNC-01/02/03)

**Wave 3** *(blocked on Wave 2)*

- [x] 05-05-PLAN.md — Data-safety UI slice: Settings surface + export/import + End-Show auto-backup (PWA-04)
...
- [x] 06-02-PLAN.md — Show-Mode polish: FAB action menu, orb label fit, InstallBanner once-per-version (D-20/21/22)

**Wave 2** *(blocked on 06-01)*

- [x] 06-03-PLAN.md — Core dex derivation: rarity tiers, deriveDex single entry point, recap assembly (fixture-tested, EVAL-05)
- [x] 06-04-PLAN.md — Album-cover pipeline: MusicBrainz/CAA → sharp → committed WebP thumbnails + manifest (D-03)

**Wave 3** *(blocked on 06-03, 06-04)*

- [x] 06-05-PLAN.md — Dex data foundation: artifact loaders (@archive/@dexAlbums), covers module, reactive useDexStats hook

**Wave 4** *(blocked on 06-05)*

- [x] 06-06-PLAN.md — Dex tab UI: album shelf + drill-in + tier/debut badges + why-detail stats (D-01..08)

**Wave 5** *(blocked on 06-06)*

- [x] 06-07-PLAN.md — Envelope v2 + Dexie v4 atomic cluster: owner field, archiveShows cache, mark/unmark helpers, Settings identity

**Wave 6** *(blocked on 06-07)*

- [x] 06-08-PLAN.md — Retro marking slice: archive search + year browse + online fallback + ArchiveBrowser (DEX-02, D-09..12)

**Wave 7** *(blocked on 06-08)*

- [x] 06-09-PLAN.md — Recap + history slice: RecapView auto-shown at End Show, Shows list, retro setlist views (SHOW-14, HIST-01)
...
- [x] 07-01-PLAN.md — Tested pure-core engine: deriveConstellation + rotationSongIds + rankOutgoing (fixture-tested) + core/app config + copy.explore

**Wave 1** *(blocked on 07-01)*

- [x] 07-02-PLAN.md — Slice 1: install react-force-graph-2d, ConstellationCanvas + ExploreView, settle-and-freeze render at #/explore

**Wave 2** *(blocked on 07-02)*

- [x] 07-03-PLAN.md — Canvas-label device spike (checkpoint): validate D-15 zoom-gating + Full-catalog perf, tune LABEL_AT_REST_TOP_K
...
- [x] 07-05-PLAN.md — Slice 3: filter FAB — rotation/full toggle + edge slider (EXPL-03/04)

**Wave 5** *(blocked on 07-05)*

- [x] 07-06-PLAN.md — Slice 4: dex overlay — silhouettes + sighting rings + zoom-gated counts + overlay switch (DEX-05)
