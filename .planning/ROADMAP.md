...
- [ ] **Phase 17: Backend Foundation & Secrets** - Provision the Supabase project — RLS'd `progress` schema, idempotent account seeding, secret hygiene, core-purity boundary
...
| 17. Backend Foundation & Secrets | v2.0 | 2/4 | In Progress|  |
